/*
Description: Sprintf with a bad bounds is allows a stack buffer to be overrun.  An attempt is made to limit the string length with a length qualifier in the format but is done incorrectly.
Keywords: Port C Size0 Complex1 BufferOverflow Stack Sprintf Unbounded
ValidArg: "a"*30
InvalidArg: "a"*100
